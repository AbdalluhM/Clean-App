...
<div class="card mb-5 mb-xl-10">
    ...
    <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
        ...
        <div class="card-title m-0">
            <h3 class="fw-bolder m-0">Update service</h3>
        </div>
        <!--end::Card title-->
    </div>
    <!--begin::Card header-->
            ...
            <div class="card-body border-top p-9">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="image-input image-input-outline" data-kt-image-input="true"
                            ...
                            <div class="image-input-wrapper w-125px h-125px"
                                style="background-image: url({{url($service->supcategory_image_path)}})"></div>
                            @else
                            <div class="image-input-wrapper w-125px h-125px"
                                style="background-image: url({{url($service->supcategory_image_path)}})"></div>
                            @endisset
                            ...
                            <label
                                ...
                                data-bs-original-title="Change image service">
                ...
                <!--end::Input group-->
                    ...
                    <div class="row mb-6">
                        ...
                        data-placeholder="Select a Main service"
                        ...
                        @if (isset($categories))
                            ...
                            <option data-kt-flag="flags/indonesia.svg" value="{{$category->id}}" @if ($category->id===$categorySelect->id)
                             selected
                            @endif> {{(app()->getLocale() == 'en')?$category->name_en:$category->name_ar}}
                            </option>
                            @endforeach
                        </select>
                        <!--end::Input-->
                       ...
                       <div class="row mb-6">
                        <div class="d-flex flex-column mb-12">
                            ...
                            <textarea class="form-control form-control-solid" rows="3" name="desc"
                                placeholder="Type Category Details">{{$service->desc}}</textarea>
                            @error('desc')
                            <div class="alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
