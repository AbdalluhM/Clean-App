                    ...
                    <div class="col-xl-4">
                        ...
                        <a href="#" class="card bg-body hoverable card-xl-stretch mb-xl-8">
                            ...
                            <div class="card-body">
                                ...
                                <!--end::Svg Icon-->
                                <div class="text-inverse-body fw-bolder fs-2 mb-2 mt-5">{{$recieves->count()}}</div>
                                <div class="fw-bold text-inverse-body fs-7">Number Recieves</div>
                            </div>
                            <!--end::Body-->
                        </a>
                    ...
                    <div class="col-xl-4">
                        ...
                        <a href="#" class="card bg-dark hoverable card-xl-stretch mb-xl-8">
                            ...
                            <div class="card-body">
                                ...
                                <!--end::Svg Icon-->
                                <div class="text-inverse-dark fw-bolder fs-2 mb-2 mt-5">{{$newcustomers->count()}}</div>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    <div class="symbol symbol-45px me-5">
                                                        <img src="{{ $service->supcategory_image_path}}" alt="" />
                                                    </div>
